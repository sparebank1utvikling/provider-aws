...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomScramSecretAssociationParameters) DeepCopyInto(out *CustomScramSecretAssociationParameters) {
	*out = *in
	...
	if in.SecretARNListRefs != nil {
		in, out := &in.SecretARNListRefs, &out.SecretARNListRefs
		*out = make([]v1.Reference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SecretARNListSelector != nil {
		in, out := &in.SecretARNListSelector, &out.SecretARNListSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.ClusterARN != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomScramSecretAssociationParameters.
func (in *CustomScramSecretAssociationParameters) DeepCopy() *CustomScramSecretAssociationParameters {
	if in == nil {
		return nil
	}
	out := new(CustomScramSecretAssociationParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ScramSecretAssociationParameters) DeepCopyInto(out *ScramSecretAssociationParameters) {
	*out = *in
	in.CustomScramSecretAssociationParameters.DeepCopyInto(&out.CustomScramSecretAssociationParameters)
}
